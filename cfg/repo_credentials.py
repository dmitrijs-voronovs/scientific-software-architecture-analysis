...
Credentials({'author': 'soedinglab', 'repo': 'MMseqs2', 'version': '15-6f452', 'wiki': 'https://github.com/soedinglab/mmseqs2/wiki'}),
Credentials({'author': 'su2code', 'repo': 'SU2', 'version': 'v8.1.0', 'wiki': 'https://su2code.github.io'}),
Credentials({'author': 'tum-pbs', 'repo': 'PhiFlow', 'version': '3.1.0', 'wiki': None}),
Credentials({'author': 'scipipe', 'repo': 'scipipe', 'version': 'v0.12.0', 'wiki': 'https://scipipe.org'}),
Credentials({'author': 'openbabel', 'repo': 'openbabel', 'version': 'openbabel-3-1-1', 'wiki': 'http://openbabel.org/'}),
Credentials({'author': 'qupath', 'repo': 'qupath', 'version': 'v0.5.1', 'wiki': 'https://qupath.github.io'}),
# Credentials({'author': 'broadinstitute', 'repo': 'cromwell', 'version': '87', 'wiki': 'http://cromwell.readthedocs.io/'}),
Credentials({'author': 'broadinstitute', 'repo': 'cromwell', 'version': '87', 'wiki': 'https://cromwell.readthedocs.io/en/latest/'}),
Credentials({'author': 'hail-is', 'repo': 'hail', 'version': '0.2.133', 'wiki': 'https://hail.is'}),
# Credentials({'author': 'psi4', 'repo': 'psi4', 'version': 'v1.9.1', 'wiki': 'http://psicode.org'}),
Credentials({'author': 'psi4', 'repo': 'psi4', 'version': 'v1.9.1', 'wiki': 'https://psicode.org'}),
Credentials({'author': 'CliMA', 'repo': 'Oceananigans.jl', 'version': 'v0.93.2', 'wiki': 'https://clima.github.io/OceananigansDocumentation/stable'}),
