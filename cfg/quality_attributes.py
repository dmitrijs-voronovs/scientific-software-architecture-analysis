...
quality_Attributes_raw = {
    'availability': ['bidirect models transform', 'parallel comput pattern', 'markov transit matrix',
    ...
    'energy efficiency': ['measur energ consum', 'reduc energ consum', 'energ efifcienc', 'green softwar',
                          ...
                          'fault', 'green', 'manag', 'meter', 'models', 'optim', 'power', 'reduc', 'scale', 'therm',
    ...
    'integrability': ['component-bas softwar', 'component-bas system', 'built-in contract', 'failur non-atom',
                      ...
                      'observ scheme', 'product famil', 'softwar evolv', 'target system', 'compon models', 'integr test',
    ...
    'interoperability': ['cots-bas system', 'models transform', 'compon base', 'matur models', 'cot compon', 'licens use',
    ...
    'modifiability': ['softwar architectur analys', 'chang scenario elicit', 'chang scenario requir',
                      ...
                      'architectur models', 'architectur view', 'qualit attribut', 'scenario elicit', 'softwar mainten',
                      ...
                      'risk assess', 'cost estim', 'view models', 'responsibil', 'polymorph', 'abstract', 'configur',
    ...
    'performance': ['perform efficien', 'workload perform', 'resourc perform', 'softwar perform', 'applic perform',
                    ...
                    'perform models', 'perform optim', 'execut models', 'perform issu', 'perform test', 'respons time',
    ...
    'safety': ['safety-crit system', 'fail-saf state', 'safety constraint', 'safety standard', 'behavior models',
               'control action', 'primar channel', 'safety pattern', 'softwar safety', 'critic system', 'process models',
               'restrict appl', 'safety analys', 'safety critic', 'safety requir', 'safety tactic', 'system safety',
               'topolog models', 'safety engin', 'gsn diagram', 'process-control', 'single-point', 'high-assur',
    ...
    'security': ['least privileg', 'incid respons', 'data protect', 'sensit data', 'man-in-the-middl',
                 ...
                 'models', 'modif', 'owasp', 'patch', 'phish', 'polic', 'recov', 'revoc', 'revok', 'rotat', 'sanit',
    ...
    'testability': ['testab transform', 'softwar testab', 'testab analysi', 'testab measure', 'testab softwar',
                    ...
                    'testab factor', 'testab metric', 'testab requir', 'qualit assur', 'testab models', 'testab refer',
