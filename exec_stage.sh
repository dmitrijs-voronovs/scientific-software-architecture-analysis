...
. .venv/bin/activate
nohup python3 -m processing_pipeline.s1_qa_relevance_check.QARelevanceCheck_v2 > data/processing_logs/v2_s1_greenlab.1_5b.v2.txt 2>&1 &
nohup python3 -m processing_pipeline.s1_qa_relevance_check.runner_2 > data/processing_logs/v2_s1_techlab.1_5b.v2.txt 2>&1 &
