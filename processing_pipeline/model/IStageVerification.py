...
class IStageVerification(IBaseStage, ABC):
    ...
    def get_system_prompt(self) -> str:
        ...
        what "plausible" means in simple, objective terms.
        """
        return """
...
Your evaluation **MUST** be pragmatic. The first AI's output does not need to be perfect. The reasoning is considered **plausible** if it is a **brief, relevant justification**, not an exhaustive analysis. For example, if the source data is a log file and the reasoning says "This is a log file," that is sufficient and plausible. **Do not be a perfectionist.**
